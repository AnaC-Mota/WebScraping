...
average_price_by_brand = df_non_zero_prices.groupby('seller')['new_money'].mean().sort_values(ascending=False)
...
satisfaction_by_brand = df_non_zero_reviews.groupby('seller')['reviews_rating'].mean().sort_values(ascending=False)
